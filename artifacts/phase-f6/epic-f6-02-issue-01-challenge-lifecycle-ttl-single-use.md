...
- cenario C: challenge nao invalidado por sucesso, 3 falhas ou rotacao de chave.
- resultado esperado: `FAIL` em `make ci-security`.
...
- lifecycle final auditado:
  - invalidacao por sucesso: `PASS`
  - invalidacao por expiracao: `PASS`
  - invalidacao por `3 falhas`: `PASS`
  - invalidacao por rotacao de chave: `PASS`
