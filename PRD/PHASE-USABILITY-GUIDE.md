...
| `F2` Pos-instalacao + baseline de seguranca | Regras minimas de qualidade e seguranca ativas | operar somente com allowlists e policy canonica | `make ci-quality`, `make ci-security` e `make eval-gates` | trio de gates `PASS` | output dos tres comandos no mesmo ciclo da fase |
...
- `F2`: [EPICS da fase](../PM/PHASES/feito/F1-INSTALACAO-BASE-OPENCLAW/F2-POS-INSTALACAO-BASELINE-SEGURANCA/EPICS.md)
- `F3`: [EPICS da fase](../PM/PHASES/feito/F3-RUNTIME-MINIMO-MEMORIA-HEARTBEAT/EPICS.md)
- `F4`: [EPICS da fase](../PM/PHASES/feito/F4-ONBOARDING-REPOS-CONTEXTO-EXTERNO/EPICS.md)
